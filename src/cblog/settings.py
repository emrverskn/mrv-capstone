...
DATABASES = {
    'default': {
        ...
        'PASSWORD': '123456789',
        'HOST': 'mrv.cmzrqmrggkmg.us-east-1.rds.amazonaws.com', # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'mrv-capstone-v1' # please enter your s3 bucket name
